...
var _el_billFetchBtn = document.getElementById('billFetchBtn');
if (_el_billFetchBtn) _el_billFetchBtn.addEventListener('click', fetchBills);
var _el_saveChangesBtn = document.getElementById('saveChangesBtn');
if (_el_saveChangesBtn) _el_saveChangesBtn.addEventListener('click', saveChanges);
var _el_ignoreChangesBtn = document.getElementById('ignoreChangesBtn');
if (_el_ignoreChangesBtn) _el_ignoreChangesBtn.addEventListener('click', () => location.reload());
